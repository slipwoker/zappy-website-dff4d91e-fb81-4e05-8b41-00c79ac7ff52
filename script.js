document.addEventListener('DOMContentLoaded', function () {
  ...
  document.addEventListener('click', function (e) {
    ...
    const navBar = document.querySelector('.navbar, .nav, header[class*="nav"], [class*="navbar"]');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'dff4d91e-fb81-4e05-8b41-00c79ac7ff52',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'dff4d91e-fb81-4e05-8b41-00c79ac7ff52';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'dff4d91e-fb81-4e05-8b41-00c79ac7ff52';
